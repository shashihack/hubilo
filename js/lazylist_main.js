    ...
    function getresult(page,page_num,value,content,id,type) {
        ...
        xhr = $.ajax({
            ...
            success: function(data){
                ...
                /* for popover which should come on hover and content should stay on hover starts */
                ...
                $('body').popover({ selector: '[data-popover]', trigger: 'click hover', placement: 'auto', delay: {show: 50, hide: 90}});
                /* for popover which should come on hover and content should stay on hover ends */

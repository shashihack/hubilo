        ...
        $('.form-validation').each(function(){
            var formValidation = $(this).validate({
                ...
                debug: "true",
                    ...
                    /*$("#submit-basic-info").attr("disabled", true);
                    if($("#submit-basic-info").attr("disabled") === 'true'){
                ...
                messages:{
                    ...
                    start_date: {required: 'Enter Start Date please.'},
                    end_date: {required: 'Enter End Date please.'},
                    description: {required: 'Enter Description please.'},

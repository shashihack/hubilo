    ...
    function search(result_page,search_in){        
        pagenum=0;
        search_value=$('#attendeedatabase_main_search').val();
        sort_by_id=$('#attendee_sort_by').val();
        sort_filter_id=$('#attendee_filter_by').val();
...
$(document).ready(function() {
    $('#attendee-grid').click(function(e){
        $("#attendee_sort_by").val("default");
        $("#attendee_filter_by").val("default");
        $("#attendeedatabase_main_search").val("");
        pagecount=0;
        pagenum=0;
        search_value="";
        active = false;
        ...
        filter_eventtype="";
        sort_by_id="";
        $('#attendee_database_main').empty();
        setListName("#attendee_database_main");
        setResultPageName('getattendeeMainDatabase_json.php');
        getresult('getattendeeMainDatabase_json.php',0,'','#attendee_database_main','','','');
    });
});

    ...
    function search(result_page,search_in){        
        pagenum=0;
        search_value=$('#speakerdatabase_main_search').val();
        sort_by_id=$('#speaker_sort_by').val();
        sort_filter_id=$('#speaker_filter_by').val();
    ...
    function showMore(id){
      $('#speaker-description-modal').modal();
      $('#modal-speaker-desc span').text(id);
    }

$(document).ready(function() {
    $('#speaker-grid').click(function(e){
        $("#speaker_sort_by").val("default");
        $("#speaker_filter_by").val("default");
        $("#speakerdatabase_main_search").val("");
        pagecount=0;
        pagenum=0;
        search_value="";
        active = false;
        ...
        filter_eventtype="";
        sort_by_id="";
        $('#speaker_database_main').empty();
        setListName("#speaker_database_main");
        setResultPageName('getspeakerMainDatabase_json.php');
        getresult('getspeakerMainDatabase_json.php',0,'','#speaker_database_main','','','');
    });
});
